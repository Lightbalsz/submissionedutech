...
with col2:
    age_at_enrollment = st.number_input("Age at Enrollment", value=22, key="age_input")
...
with col1:
    curr_1st_enrolled = int(st.number_input("Enrolled (0 - 30)", 0, 30, 20, key="1st_enrolled"))
    raw_data["Curricular_units_1st_sem_enrolled"] = [curr_1st_enrolled]

with col2:
    curr_1st_eval = int(st.number_input("Evaluations (0 - 50)", 0, 50, 35, key="1st_eval"))
    raw_data["Curricular_units_1st_sem_evaluations"] = [curr_1st_eval]

with col3:
    curr_1st_approved = int(st.number_input("Approved (0 - 30)", 0, 30, 20, key="1st_approved"))
    raw_data["Curricular_units_1st_sem_approved"] = [curr_1st_approved]

with col4:
    curr_1st_grade = float(st.number_input("Grade (0 - 20)", 0.0, 20.0, 17.0, key="1st_grade"))
...
with col1:
    curr_2nd_enrolled = int(st.number_input("Enrolled (0 - 30)", 0, 30, 20, key="2nd_enrolled"))
    raw_data["Curricular_units_2nd_sem_enrolled"] = [curr_2nd_enrolled]

with col2:
    curr_2nd_eval = int(st.number_input("Evaluations (0 - 50)", 0, 50, 35, key="2nd_eval"))
    raw_data["Curricular_units_2nd_sem_evaluations"] = [curr_2nd_eval]

with col3:
    curr_2nd_approved = int(st.number_input("Approved (0 - 30)", 0, 30, 20, key="2nd_approved"))
    raw_data["Curricular_units_2nd_sem_approved"] = [curr_2nd_approved]

with col4:
    curr_2nd_grade = float(st.number_input("Grade (0 - 20)", 0.0, 20.0, 17.0, key="2nd_grade"))
